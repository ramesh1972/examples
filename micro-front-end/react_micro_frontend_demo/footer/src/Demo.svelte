...
<div class="container">
  ...
  <ul class="list">
    ...
    <li ><span class="highlight">A single deploy script</span> to used deploy locally for dev & <span class="highlight">a shell script</span> to deploy for production via CI/CD is developed</li>
